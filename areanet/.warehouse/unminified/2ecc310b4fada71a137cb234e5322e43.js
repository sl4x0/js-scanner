...
YUI.add("hom-print-btn", (function(t) {
  "use strict";
  t.delegate("mouseenter", (function(t) {
    t.currentTarget.one("ul").transition({
      height: "90px",
      duration: .1
    })
  }), "#monitor", ".print"), t.delegate("mouseleave", (function(t) {
    t.currentTarget.one("ul").transition({
      height: 0,
      duration: .1
    })
  }), "#monitor", ".print"), t.delegate("click", (function(e) {
    t.namespace("hom").pageControl.set("page", "print")
  }), "#monitor", ".print .main")
}), "@VERSION@", {
  requires: ["event-mouseenter", "transition"]
});