...
var m = function a(b, c) {
  ...
  function e() {
    var a, b = [].slice.call(arguments),
      ...
      g = [];
    if (L.call(b[0]) != J) throw new Error("selector in m(selector, attrs, children) should be a string");
    for (; a = M.exec(b[0]);)
    ...
    for (var j in d) d.hasOwnProperty(j) && (j === e && null != d[j] && "" !== d[j] ? (g.push(d[j]), f.attrs[j] = "") : f.attrs[j] = d[j]);
  ...
  function f(a, b, d, j, l, m, n, o, p, q, r) {
    ...
    if (u === I) {
      for (var x = 0, y = l.length; y > x; x++) L.call(l[x]) === I && (l = l.concat.apply([], l), x--, y = l.length);
      for (var z = [], A = m.length === l.length, B = 0, C = 1, E = 2, F = 3, G = {}, M = !1, x = 0; x < m.length; x++) m[x] && m[x].attrs && null != m[x].attrs.key && (M = !0, G[m[x].attrs.key] = {
        action: C,
        index: x
      });
      for (var N = 0, x = 0, y = l.length; y > x; x++)
        if (l[x] && l[x].attrs && null != l[x].attrs.key) {
          for (var Q = 0, y = l.length; y > Q; Q++) l[Q] && l[Q].attrs && null == l[Q].attrs.key && (l[Q].attrs.key = "__mithril__" + N++);
          break
        } if (M) {
        var R = !1;
      ...
      if (!A) {
        for (var x = 0, y = l.length; y > x; x++) null != m[x] && z.push.apply(z, m[x].nodes);
        for (var cb, x = 0; cb = m.nodes[x]; x++) null != cb.parentNode && z.indexOf(cb) < 0 && i([cb], [m[x]]);
      ...
      for (var eb = [], fb = []; l.view;) {
        ...
        if (l = 0 == db || m && m.controllers && m.controllers.indexOf(ib) > -1 ? l.view(ib) : {
            tag: "placeholder"
      ...
      if (!l.tag && fb.length) throw new Error("Component template must return a virtual element, not an array, string, etc.");
      ...
      if ((l.tag != m.tag || jb.sort().join() != Object.keys(m.attrs).sort().join() || l.attrs.id != m.attrs.id || l.attrs.key != m.attrs.key || "all" == e.redraw.strategy() && (!m.configContext || m.configContext.retain !== !0) || "diff" == e.redraw.strategy() && m.configContext && m.configContext.retain === !1) && (m.nodes.length && i(m.nodes), m.configContext && typeof m.configContext.onunload === K && m.configContext.onunload(), m.controllers))
        for (var ib, x = 0; ib = m.controllers[x]; x++) typeof ib.onunload === K && ib.onunload({
          preventDefault: P
        });
      ...
      if (l.attrs.xmlns ? q = l.attrs.xmlns : "svg" === l.tag ? q = "http://www.w3.org/2000/svg" : "math" === l.tag && (q = "http://www.w3.org/1998/Math/MathML"), lb) {
        ...
        m.children && !m.children.nodes && (m.children.nodes = []), "select" === l.tag && "value" in l.attrs && h(cb, l.tag, {
          value: l.attrs.value
        }, {}, q), a.insertBefore(cb, a.childNodes[o] || null)
      } else cb = m.nodes[0], kb && h(cb, l.tag, l.attrs, m.attrs, q), m.children = f(cb, l.tag, c, c, l.children, m.children, !1, 0, l.attrs.contenteditable ? cb : p, q, r), m.nodes.intact = !0, fb.length && (m.views = eb, m.controllers = fb), n === !0 && null != cb && a.insertBefore(cb, a.childNodes[o] || null);
  ...
  function h(a, b, c, d, e) {
    for (var f in c) {
      var g = c[f],
        h = d[f];
      if (f in d && h === g) "value" === f && "input" === b && a.value != g && (a.value = g);
      else {
        d[f] = g;
        try {
          ...
          } else null != e ? "href" === f ? a.setAttributeNS("http://www.w3.org/1999/xlink", "href", g) : "className" === f ? a.setAttribute("class", g) : a.setAttribute(f, g) : f in a && "list" !== f && "style" !== f && "form" !== f && "type" !== f && "width" !== f && "height" !== f ? ("input" !== b || a[f] !== g) && (a[f] = g) : a.setAttribute(f, g)
        } catch (j) {
  ...
  function j(a) {
    if (a.configContext && typeof a.configContext.onunload === K && (a.configContext.onunload(), a.configContext.onunload = null), a.controllers)
      for (var b, c = 0; b = a.controllers[c]; c++) typeof b.onunload === K && b.onunload({
        preventDefault: P
      });
    if (a.children)
  ...
  function r(a, b, c) {
    fb = {};
    var d = c.indexOf("?"); - 1 !== d && (fb = v(c.substr(d + 1, c.length)), c = c.substr(0, d));
    var f = Object.keys(b),
      g = f.indexOf(c);
    ...
    for (var h in b) {
      ...
      if (i.test(c)) return c.replace(i, function() {
        for (var c = h.match(/:[^\/]+/g) || [], d = [].slice.call(arguments, 1, -2), f = 0, g = c.length; g > f; f++) fb[c[f].replace(/:|\./g, "")] = decodeURIComponent(d[f]);
        e.mount(a, b[h])
      }), !0
    }
  }
  ...
  function s(a) {
    if (a = a || event, !a.ctrlKey && !a.metaKey && 2 !== a.which) {
      ...
      for (var b = a.currentTarget || a.srcElement, c = "pathname" === e.route.mode && b.search ? v(b.search.slice(1)) : {}; b && "A" != b.nodeName.toUpperCase();) b = b.parentNode;
  ...
  function y(a, b) {
    ...
    function d(a, b, c, d) {
      if ((null != m && L.call(m) === H || typeof m === K) && typeof a === K) try {
        var f = 0;
        a.call(m, function(a) {
          f++ || (m = a, b())
        }, function(a) {
  ...
  e.component = function(a) {
    ...
    for (var d, f = !1, g = {
      ...
      }, h = 0; d = ab[h]; h++) d.handler.call(d.controller, g), d.controller.onunload = null;
    if (f)
  ...
  return e.route = function() {
    ...
    if (3 === arguments.length && L.call(arguments[1]) === J) {
      ...
      ib = function(b) {
        var f = gb = q(b);
        if (!r(a, d, f)) {
          if (jb) throw new Error("Ensure the default route matches one of the routes defined in m.route");
    ...
    if (!fb) throw new Error("You must call m.route(element, defaultRoute, routes) before calling m.route.param()");
    return fb[a]
    ...
    if ("[object Error]" === L.call(a) && !a.constructor.toString().match(/ Error/)) throw a
  }, e.sync = function(a) {
    function b(a, b) {
      return function(e) {
...
"undefined" != typeof module && null !== module && module.exports ? module.exports = m : "function" == typeof define && define.amd && define(function() {
  return m
});
...
(function() {
  ...
  function n() {
    function t() {
      if (arguments.length > 0 && arguments[0] !== e) r(t, arguments[0]);
      return t._state.value
    }
    a(t);
    if (arguments.length > 0 && arguments[0] !== e) r(t, arguments[0]);
    return t
  ...
  function a(e) {
    ...
    e.map = e["fantasy-land/map"] = _, e["fantasy-land/ap"] = l, e["fantasy-land/of"] = n;
    e.valueOf = v, e.toJSON = p, e.toString = v;
    Object.defineProperties(e, {
      end: {
        get: function() {
          if (!e._state.endStream) {
            var t = n();
            t.map(function(n) {
              if (n === true) {
                d(e);
                t._state.unregister = function() {
                  d(t)
                }
              }
              return n
            });
            e._state.endStream = t
          }
          return e._state.endStream
        }
      }
    })
  }
  ...
  function r(t, e) {
    s(t, e);
    for (var n in t._state.deps) i(t._state.deps[n], false);
    if (t._state.unregister != null) t._state.unregister();
    u(t)
  }

  function s(t, e) {
    t._state.value = e;
    t._state.changed = true;
    if (t._state.state !== 2) t._state.state = 1
  }

  function i(t, n) {
    var a = t._state,
      r = a.parents;
    if (r.length > 0 && r.every(h) && (n || r.some(g))) {
      var i = t._state.derive();
      if (i === e) return false;
      s(t, i)
    }
  }
  ...
  function u(t) {
    t._state.changed = false;
    for (var e in t._state.deps) t._state.deps[e]._state.changed = false
  }

  function f(t, e) {
    if (!e.every(m)) throw new Error("Ensure that each item passed to stream.combine/stream.merge is a stream");
    return o(n(), e, function() {
      return t.apply(this, e.concat([e.filter(g)]))
    })
  }
  ...
  function c(t, e) {
    for (var n = 0; n < e.length; n++) {
      e[n]._state.deps[t._state.id] = t;
      c(t, e[n]._state.parents)
    }
  }

  function d(t) {
    for (var e = 0; e < t._state.parents.length; e++) {
      var n = t._state.parents[e];
      delete n._state.deps[t._state.id]
    }
    for (var a in t._state.deps) {
      var r = t._state.deps[a];
      var s = r._state.parents.indexOf(t);
      if (s > -1) r._state.parents.splice(s, 1)
    }
    t._state.state = 2;
    t._state.deps = {}
  }
  ...
  function h(t) {
    return t._state.state === 1
  }

  function g(t) {
    return t._state.changed
  }

  function w(t) {
    return t._state.state !== 2
  }
  ...
  function S(t, e, n) {
    var a = f(function(n) {
      return e = t(e, n._state.value)
    }, [n]);
    if (a._state.state === 0) a(e);
    return a
  }
  ...
  function O(t, e) {
    var n = t.map(function(t) {
      var e = t[0];
      if (e._state.state === 0) e(undefined);
      return e
    });
    var a = f(function() {
  ...
  else if (typeof window.m === "function" && !("stream" in window.m)) window.m.stream = n;
  else window.m = {
    stream: n
  }
})();