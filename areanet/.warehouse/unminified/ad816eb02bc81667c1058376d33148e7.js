...
YUI.add("hom-todo", (function(e) {
  "use strict";
  const t = e.Lang,
    o = e.namespace("hom");
  o.Todo = e.Base.create("Todo", e.Base, [], {
    _timer: null,
    initializer() {
      const i = {
        emitFacade: !1,
      ...
      function n(i) {
        let n = i.currentTarget,
          s = {
            on: "mouseenter" === i.type
          },
          a = o.Todo.data(e.merge(o.Todo._itemRetriever(n), s), s.on);
        s.on ? (this._timer && t.isFunction(this._timer.cancel) && this._timer.cancel(), this.fire("hover", a), n = a = s = null) : this._timer = e.later(100, this, (function() {
          this.fire("hover", a), n = a = s = null
        }))
      }

      function s(t) {
        e.Cookie.setSub("todo", "display", t.newVal)
      }
      this.parse(e.Cookie.getSub("todo", "values")), this.publish("hover", i), this.publish("change", i), e.delegate("mouseenter", n, "body", ".todo-item", this), e.delegate("mouseleave", n, "body", ".todo-item", this), e.delegate("click", (function(e) {
        e.preventDefault();
        let t = e.currentTarget,
          i = o.Todo._itemRetriever(t);
        this.set(`${i.section}.${i.item.replace(/\./g,"-")}`, t.hasClass("on-todo") ? 0 : 1), t = i = null
      }), "body", ".todo-item", this), this.after(["devotionChange", "fellowshipChange", "honorChange", "resilienceChange", "valorChange"], (function(e) {
        let t;
        e.subAttrName && (t = e.subAttrName.split(".")[1]), this.fire("change", o.Todo.data({
          section: e.attrName,
          item: t || null,
          value: e.newVal[t]
        }))
      })), this.after("change", (function(t) {
        const i = e.clone(this.getValues());
        i.fellowship["M-O-X-"] && (i.fellowship["M.O.X."] = 1, delete i.fellowship["M-O-X-"]);
        const n = o.Points.putBits(i);
        e.Cookie.setSub("todo", "values", n)
      }), this), this.after("displayChange", s), s({
        newVal: this.get("display")
      })
    },
    parse(t) {
      t && (t = o.Points.parseBits(t), e.each(t, (function(o, i) {
        e.each(o, (function(e, o) {
          e || delete t[i][o]
        }))
      })), t.fellowship["M.O.X."] && (t.fellowship["M-O-X-"] = 1, delete t.fellowship["M.O.X."]), this.setAttrs(t))
    },
    getValues(e) {
      return this.getAttrs(e || ["devotion", "fellowship", "honor", "resilience", "valor"])
    },
    getComputedValues(i) {
      const n = o.points.get("character"),
        s = this.getValues(i),
        a = e.aggregate(e.clone(n), s, !0);
      return e.each(n.devotion, (function(e, o) {
        t.isValue(s.devotion[o]) && (a.devotion[o] = (t.isNumber(a.devotion[o]) ? a.devotion[o] : 0) + e)
      })), a
    },
    urlData: () => e.Cookie.getSub("todo", "values")
  }, {
    ATTRS: {
      display: {
        valueFn() {
          const o = e.Cookie.getSub("todo", "display", (function(e) {
            return "true" === e
          }));
          return !t.isBoolean(o) || o
        },
    ...
    _itemRegex: /section\-(\w+)/,
    _itemRetriever(e) {
      const t = e.ancestor("ul"),
        i = {
          section: null,
          item: null
        };
      return e.test("li") || (e = e.ancestor("li")), i.item = e.one(".txt").get("innerHTML"), i.section = t.get("className").match(o.Todo._itemRegex), i.section[1] && (i.section = i.section[1]), i
    },
    data(i, n) {
      const s = o.Points[`${i.section}Points`],
        a = o.points.get(`character.${i.section}`),
        l = o.todo.get(i.section),
        r = {
          complete: a,
          todo: o.todo.get("display") ? e.merge(a, l) : {},
          hover: {}
        };
      "devotion" === i.section && e.each(a, (function(e, o) {
        r.todo[o] = a[o] + (t.isNumber(l[o]) ? l[o] : 0)
      }));
      const c = {
        complete: o.points.get(i.section),
        todo: s(r.todo),
        hover: {}
      };
      return n && (r.hover = e.clone(r.todo), i.item = i.item.replace(/\./g, "-"), "devotion" === i.section ? r.hover[i.item] += i.on : r.hover[i.item] = i.on, c.hover = s(r.hover)), {
        details: i,
        items: r,
        points: c
      }
