...
YUI.add("hom-points-header", (function(t) {
  "use strict";
  t.once("loader_monitor:ready", (function() {
    const o = t.namespace("hom"),
      e = o.points;

    function a(a) {
      const n = t.one("#monitor .details .points"),
        i = o.Points.parseObject(o.todo.getComputedValues());
      let s, d = e.get("total");
      a.type && "displayChange" === a.type ? a.newVal && i.total > d && (d = i.total, s = "todo-txt") : o.todo.get("display") && i.total > d && (s = "todo-txt", d = i.total), (!s || t.Lang.isBoolean(a.newVal) && !a.newVal) && n.removeClass("todo-txt"), s && n.addClass(s), o.pointsAnim(n, d, .1)
    }
    e.after("totalChange", a), o.todo.after(["change", "displayChange"], a), a({
      type: "displayChange",
      newVal: o.todo.get("display")
    })
  }))
}), "@VERSION@", {
  requires: ["node", "hom-points", "hom-todo", "hom-points-animator", "hom-print-btn", "hom-link-btn", "hom-loader-monitor"]
