...
YUI.add("main-page", (function(t) {
  "use strict";
  const e = t.namespace("hom");

  function o() {
    t.once("loader_main:ready", (function() {
      const o = e.points;
      this._setupBanners(), o.after("valueChange", this._attrChange, this), t.each(["devotion", "fellowship", "honor", "resilience", "valor"], (function(t) {
        this._attrChange({
          newVal: o.get(t),
          attrName: t
        })
      }), this), e.todo.after("displayChange", this._todoDisplay, this), e.todo.after("change", this._todoUpdateColumn, this), this._todoDisplay(), o.on("updatesuccess", this.resetBanners), t.on("domready", (function() {
        new e.ItemModal
      }))
    }), this)
  }
  o.prototype = {
    ...
    resetBanners: function() {
      t.each(["devotion", "fellowship", "honor", "resilience", "valor"], (function(e) {
        t.all(`#banner-${e} .bd ol li`).removeClass("(todo|active)")
      }))
    },
    _setupBanners: function() {
      const o = t.one("#main"),
        n = t.all("#main .highlight");
      n.each((function(t) {
        t.on("transition:start", (function(t) {
          t.config.opacity > 0 && t.currentTarget.removeClass("hide")
        })), t.on("transition:end", (function(t) {
          0 === t.config.opacity && t.currentTarget.addClass("hide")
        }))
      })), t.delegate("mouseenter", (function(t) {
        const e = t.target.ancestor("li").get("id").split("-")[1];
        n.filter(`.highlight-${e}`).item(0).transition({
          duration: new Date - this._leaveTime < 250 ? 0 : .2,
          easing: "ease-in",
          opacity: 1
        })
      }), o, ".btn-wrapper a", this), t.delegate("mouseleave", (function(t) {
        this._leaveTime = Number(new Date);
        const e = t.target.ancestor("li").get("id").split("-")[1];
        n.filter(`.highlight-${e}`).item(0).transition({
          duration: .5,
          easing: "ease-out",
      ...
      }), o, ".btn-wrapper a", this), t.delegate("click", (function(t) {
        t.preventDefault(), e.tab = o.all(".group").indexOf(t.currentTarget.ancestor("li.group")), e.pageControl.set("page", "details")
      }), o, "a.btn", this)
    },
    _attrChange: function(o) {
      const n = t.one(`#banner-${o.attrName}`);
      e.pointsAnim(n.one(".points"), o.newVal.total);
      const a = n.all("ol li"),
        i = a.filter(".active"),
        s = o.newVal.total - i.size();
      if (0 !== s) {
        const e = new t.GenericAnim({
          steps: Math.abs(s)
        });
        e.on("step", (function(t) {
          const e = s < 0 ? a.size() - i.size() + Math.abs(t - 1) : a.size() - i.size() - t,
            o = a.item(e);
          o && o[s < 0 ? "removeClass" : "addClass"]("active")
        })), e.run()
      }
    },
    _todoUpdateColumn: function(o) {
      const n = e.todo.get("display"),
        a = t.one(`#banner-${o.details.section}`),
        i = a.one(".points"),
        s = a.all(".vert-bar .cell");
      let l = "",
        r = o.points.complete.total;
      n && (o.points.hover.total > o.points.todo.total && o.points.hover.total > o.points.complete.total ? (l = "todo-hover-txt", r = o.points.hover.total) : o.points.todo.total > o.points.complete.total && (l = "todo-txt", r = o.points.todo.total)), i.replaceClass("(todo-hover-txt|todo-txt)", l), e.pointsAnim(i, r), s._nodes.reverse(), s.removeClass("todo"), s.each((function(t, e) {
        e >= o.points.complete.total && e < r && t.addClass("todo")
      }))
    },
    _todoDisplay: function() {
      const o = e.todo.getValues();
      t.each(o, (function(t, o) {
        this._todoUpdateColumn(e.Todo.data({
          section: o
        }))
      }), this)
    }
  }, e.pageControl.constructors.main = o
}), "@VERSION@", {
  requires: ["event-custom", "transition", "anim", "hom-item-modal", "hom-points-header", "hom-reward-meter", "hom-points", "hom-points-animator", "hom-loader-main", "main-page-css"]
});