  ...
  var e = {
      ...
      648: (e, t, n) => {
        ...
        const r = "mcc31d68ed_anetDimebar",
          ...
          s = "mcc31d68ed_supportInfo",
          c = "mcc31d68ed_downloadBtn",
          u = "mcc31d68ed_anetLogo",
          f = "mcc31d68ed_langSelectBar",
          d = "mcc31d68ed_currentLang",
          p = {
            anetDimebar: r,
            anetDimebarAbs: a,
            wrapper: o,
      ...
      746: (e, t, n) => {
        ...
        const r = "mc4c81cf40_footer",
          ...
          f = u + " mc4c81cf40_youtube",
          d = u + " mc4c81cf40_facebook",
          ...
          var u, f = function(e) {
            ...
            g = function(e) {
              ...
              function c(e, n, o, l, d) {
                ...
                switch (n.state = {}, null != n.attrs && N(n.attrs, n, o), p) {
                  case "#":
              ...
              function f(e, n) {
                ...
                if (e._state = e.state, null != e.attrs && N(e.attrs, e, n), N(e._state, e, n), e.instance = t.normalize(e._state.view.call(e.state, e)), e.instance === e) throw Error("A view cannot return the vnode it received as argument");
              ...
              function d(e, t, n, r, a, o, i) {
                if (t !== n && (null != t || null != n))
                  ...
                  for (var d, v = 0, y = 0, k = t.length - 1, A = n.length - 1; k >= v && A >= y;)
                    ...
                    y++, p(e, C, S, a, h(t, ++v, o), x, i), r && C.tag === S.tag && w(e, m(C), o)
                  } else if ((C = t[k]) !== S || r)
                    if (null == C) k--;
                    else if (null == S) y++;
                  else {
                    if (C.key !== S.key) break;
                    x = null != f && k >= t.length - f.length || null == f && r, p(e, C, S, a, h(t, k + 1, o), x, i), (r || y < A) && w(e, m(C), h(t, v, o)), k--, y++
                  } else k--, y++;
                  else v++, y++;
                  for (; k >= v && A >= y;) {
                    var C, S;
                    ...
                    else if (C.key === S.key) x = null != f && k >= t.length - f.length || null == f && r, p(e, C, S, a, h(t, k + 1, o), x, i), r && C.tag === S.tag && w(e, m(C), o), null != C.dom && (o = C.dom), k--, A--;
                    else {
                      if (d || (d = g(t, k)), null != S) {
                        var N = d[S.key];
                        if (null != N) {
                          var _ = t[N];
                          x = null != f && N >= t.length - f.length || null == f && r, p(e, _, S, a, h(t, k + 1, o), r, i), w(e, m(_), o), t[N].skip = !0, null != _.dom && (o = _.dom)
                        } else o = c(e, S, a, i, o)
                      }
                      A--
                    } else k--, A--;
              ...
              function p(e, n, r, a, o, l, s) {
                ...
                if (g === r.tag) {
                  ...
                  if ("string" == typeof g) switch (null != r.attrs && (l ? (r.state = {}, N(r.attrs, r, a)) : _(r.attrs, r, a)), g) {
                    case "#":
                      ! function(e, t) {
                      ...
                      ! function(e, n, r, a, o) {
                        ...
                        o = i(n) || o, "textarea" === n.tag && (null == n.attrs && (n.attrs = {}), null != n.text && (n.attrs.value = n.text, n.text = void 0)),
                          function(e, t, n, r) {
                            ...
                            if (null != t)
                              for (var a in t) null != n && a in n || ("className" === a && (a = "class"), "o" !== a[0] || "n" !== a[1] || C(a) ? "key" !== a && e.dom.removeAttribute(a) : S(e, a, void 0))
              ...
              function x(e, t, n, r, a) {
                ...
                if ("key" !== t && "is" !== t && (n !== r || function(e, t) {
                  ...
                  else if ("o" === t[0] && "n" === t[1] && "function" == typeof r) S(e, t, r);
        ...
        e.exports = {
          ...
          view(e) {
            ...
            return r("nav", {
              ...
              class: a.anetLogo,
              href: `https://www.arena.net/${m}`,
              "data-ga-event": "",
              "data-ga-category": "Header"
            }, "ArenaNet"), u.map((e => r("a", {
              href: `https://www.arena.net/${m}/${c[e].slug}`,
              "data-ga-event": "",
              "data-ga-category": "Header",
              "data-selected": t === c[e].slug ? "current" : ""
            }, c[e].name))), r("a", {
              href: `${g.nav.shoplink.slug}`,
              target: "_blank",
              rel: "noreferrer",
              "data-ga-event": "",
              "data-ga-category": "Header"
            }, g.nav.shoplink.name)), r("ul", {
              class: a.supportInfo
            }, n ? null : d.filter((t => {
              const n = !1 === e.attrs[t],
              ...
              const n = Object.assign({
                ...
                href: l.dimebar[t]?.[m] || e.attrs[t],
                target: "_blank",
                rel: "noopener"
              });
              let a = f[t];
              return "login" !== t || window.location.href.includes("account") || e.attrs.login || (a = f.account), r("li", r("a", n, a))
            })), p.length ? r("li", {
