...
(function() {
  (function D() {
    function x(a, e) {
      var f = {},
        d;
      for (d = a.length - 1; - 1 < d; d--) 0 < d ? f[d] = function() {
        var k = d;
        return function() {
    ...
    function y(a, e, f) {
      ...
      w.test(a[1]) && k !== a[1] && g("loader: Overriding configured version with staticVer.");
      d.setAttribute("src", a[0]);
      d && d.addEventListener ? d.addEventListener("error",
        function() {
          b[f + "_" + q + "_load_failure"] = "true"
        }) : d.attachEvent && d.attachEvent("onerror", function() {
        b[f + "_" + q + "_load_failure"] = "true"
      });
      e && (d.onload = e);
    ...
    function g(a) {
      if ("function" === typeof c.trace_handler) try {
    ...
    function l(a, e) {
      ...
      return !f || "1" !== a.toString() && "true" !== a.toString().toLowerCase() ? !f || "0" !== a.toString() && "false" !== a.toString().toLowerCase() ? "boolean" === typeof e ?
        e : !1 : !1 : !0
    }
    ...
    var p = window,
      ...
      t = [],
      w = /^[0-9]{1,3}(\.[0-9]{1,3}){2}\/$/;
    if (b.loaderMain) return g("loader: Loader script has already run, try reducing the number of places it's being included."),
      !1;
    b.loaderMain = D;
    b.loaderVer = "5.8.1";
    (function() {
      for (var a = l(b.tp, !0), e = l(b.fp_static, !0), f = l(b.fp_dyn, !0), d = l(b.enable_legacy_compatibility), k = l(b.tp_split), h = b.tp_host; h && "/" === h.charAt(h.length - 1);) h = h.slice(0, -1);
      ...
      b.tp_host = q;
      m = "?loaderVer=" + b.loaderVer + "&compat=" + d + "&tp=" + a + "&tp_split=" + k + m + "&fp_static=" + e + "&fp_dyn=" + f + E + (C ? "" : "&enable_ip=" + C);
      a || e || g("loader: Not currently configured to load fp_static or tp script(s).");
      c.fp && c.fp.staticVer && c.fp.staticVer + "/" !== n && (n = z(c.fp.staticVer + "/"), g("loader: Configured version replaced with that from pre-loaded static script."));
      e || c.fp && c.fp.staticMain ? (u = (u + "##version##" + B).replace(/\/\//g, "/"),
      ...
      a && (c.io && c.io.staticMain ? g("loader: Third party script has already been loaded.") : (a = q + "/##version##" + B, k ? (t.push([a + "static_wdp.js" + m, n]), t.push([a + "dyn_wdp.js" + m, n]), b.tp_resource && g("loader: Invalid Config: both tp_resource and tp_split set. Ignoring tp_resource.")) : t.push([a + h + m, n])))
    })();
    x(r, "fp");
    x(t, "io")
  })();
