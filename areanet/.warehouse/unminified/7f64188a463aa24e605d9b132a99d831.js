...
YUI.add("gallery-overlay-transition", function(e) {
  var t = e.Lang;
  e.Plugin.TransitionOverlay = e.Base.create("overlayTransitionPlugin", e.Plugin.Base, [], {
    _aligned: !1,
    initializer: function(e) {
      var t = this;
      t._host = t.get("host"), t._bb = t._host.get("boundingBox"), t.publish({
        start: {
          preventable: !1
        },
        end: {
      ...
      }), "_syncUIPosAlign" in t._host && (t._aligned = !0, t.doAfter("_uiSetVisible", t._alignDone)), t.doBefore("_uiSetVisible", t._uiAnimSetVisible)
    },
    destructor: function() {
      this._host = this._bb = this._showing = this._styles = null
    },
    _alignDone: function(e) {
      var t = this.doAfter("_uiSetAlign", function() {
        this._uiAnimSetVisible(this._host.get("visible"), !0), t.detach()
      })
    },
    _uiAnimSetVisible: function(t, n) {
      var r = this;
      return (!this._aligned || n) && r._host.get("rendered") && (r.fire("start", t), t && r._uiSetVisible(t), r._bb.transition(r.get(t ? "show" : "hide"), function() {
        r.fire("end", t), !t && r._uiSetVisible(t)
      })), new e.Do.Prevent("AnimPlugin prevented default show/hide")
    },
    _uiSetVisible: function(e) {
      this._bb.toggleClass(this._host.getClassName("hidden"), !e)
    }
  }, {
    NS: "transitionPlugin",
    ATTRS: {
  ...
  requires: ["base-build", "plugin", "event-custom", "transition"]
})