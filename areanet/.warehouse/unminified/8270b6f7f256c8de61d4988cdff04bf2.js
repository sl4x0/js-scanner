...
YUI(YUI_config, gallery_config, HOM_config).use("hom-page-control", "gallery-preload", (function(o) {
  "use strict";
  o.namespace("hom").pageControl.once("pageChange", (function() {
    o.preload(["https://2hom.staticwars.com/img/main-bg.17f26aa8.jpg", "https://2hom.staticwars.com/img/main-bg-hover.d1dcfa17.jpg"])
  }))
}));