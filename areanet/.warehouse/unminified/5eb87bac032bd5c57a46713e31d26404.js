...
YUI.add("gallery-idletimer", function(e) {
  function s() {
    clearTimeout(n), r && (t && o(), n = setTimeout(o, i))
  }

  function o() {
    t = !t, e.IdleTimer.fire(t ? "idle" : "active")
  }
  var t = !1,
    n = -1,
    r = !1,
  ...
  e.IdleTimer = {
    ...
    start: function(u) {
      r = !0, t = !1, typeof u == "number" && (i = u), e.on("mousemove", s, document), e.on("keydown", s, document), n = setTimeout(o, i)
    },
    stop: function() {
      r = !1, clearTimeout(n), e.detach("mousemove", s, document), e.detach("keydown", s, document)
    }
  }, e.augment(e.IdleTimer, e.Event.Target)
}, "@VERSION@", {
