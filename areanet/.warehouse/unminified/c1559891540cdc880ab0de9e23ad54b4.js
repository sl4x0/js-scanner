    ...
    gallery: {
      ...
      modules: {
        "gallery-event-nav-keys": {
          path: "event-nav-keys-min.js",
          requires: ["event-synthetic"]
        },
        "gallery-event-visible": {
          path: "event-visible-min.js",
          requires: ["event-synthetic", "event-resize", "node", "yui-throttle"]
        },
        "gallery-helper-i18n": {
          path: "helper-i18n-min.js",
          requires: ["handlebars-base"]
        },
        "gallery-idletimer": {
          path: "idletimer-min.js",
          requires: ["event", "event-custom"]
        },
        "gallery-lazy-load": {
          path: "lazy-load-min.js",
          requires: ["oop"]
        },
        "gallery-overlay-transition": {
          path: "overlay-transition-min.js",
          requires: ["base-build", "plugin", "event-custom", "transition"]
        },
        "gallery-parseuri": {
          path: "parseuri-min.js"
        },
        "gallery-preload": {
          path: "preload-min.js"
        },
        "gallery-scroll-beacon": {
          path: "gallery-scroll-beacon-min.js",
          requires: ["event-synthetic", "dom-screen", "node"]
        },
        "gallery-debounce": {
