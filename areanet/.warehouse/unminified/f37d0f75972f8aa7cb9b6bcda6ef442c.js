...
YUI.add("gallery-parseuri", function(r) {
  "use strict"
  var e = {
    strictMode: !1,
  ...
  r.parseUri = function(r) {
    for (var t = e, o = t.parser[t.strictMode ? "strict" : "loose"].exec(r), s = {}, a = 14; a--;) s[t.key[a]] = o[a] || ""
    return s[t.q.name] = {}, s[t.key[12]].replace(t.q.parser, function(r, e, o) {
      e && (s[t.q.name][e] = o)
    }), s
  }
})