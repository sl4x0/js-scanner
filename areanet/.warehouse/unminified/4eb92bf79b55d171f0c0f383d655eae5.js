...
YUI.add("gallery-helper-i18n", function(e) {
  "use strict";
  var r, n = e.Lang,
    a = e.Object;
  e.Handlebars.registerHelper("i18nBase", function(e) {
    var i = a.getValue(window, e.split("."));
    if (!n.isObject(i)) throw Error("Unable to find object window." + e);
    r = i
  }), e.Handlebars.registerHelper("i18n", function(i, t) {
    var s = a.getValue(r || window, i.split(".")) || "";
    return a.keys(t.hash).length && (s = new e.Handlebars.SafeString(n.sub(s, t.hash))), s
  })
}, "", {
  requires: ["handlebars-base"]
});