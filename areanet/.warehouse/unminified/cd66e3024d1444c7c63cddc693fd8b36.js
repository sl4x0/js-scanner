...
YUI.add("gallery-lazy-load", function(e) {
  (function(e) {
    "use strict";
    var t = e.Array,
      n = e.Env,
    ...
    e.lazyLoad = function() {
      var n = t(arguments),
        ...
        d = o.onFailure,
        v = o.onTimeout;
      return f(c) ? n.pop() : c = null, a(n[0]) && (n = n[0]), c ? (u(i, function(e, t) {
        e && (r[t] = e)
      }), delete s.loadErrorFn, o.onFailure = function(e) {
        h.push(e)
      }, o.onTimeout = function(e) {
        h.push(e)
      }, n.push(function() {
        s.loadErrorFn = p, o.onFailure = d, o.onTimeout = v;
        var e = {};
        u(i, function(t, n) {
          t && !r[n] && (e[n] = t)
        }), c(h.length ? h : null, e)
      }), l.apply(e, n)) : l.apply(e, n)
    }
  })(e)
