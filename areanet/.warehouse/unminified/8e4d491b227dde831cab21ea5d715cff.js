...
YUI.add("hom-loader-details", (function(e) {
  "use strict";
  const a = e.one("#details");
  a.hasClass("loaded") || new e.Dispatcher({
    node: a,
    uri: `/html/${HOM.lang}/details`,
    on: {
      ready: function() {
        a.addClass("loaded"), e.publish("loader_details:ready", {
          broadcast: 2,
          emitFacade: !1,
          fireOnce: !0
        }).fire()
