...
YUI.add("attribute-core", function(e, t) {
  ...
  var n = e.Object,
    ...
    b = "isLazyAdd",
    w;
  E.INVALID_VALUE = {}, w = E.INVALID_VALUE, E._ATTR_CFG = [o, s, l, c, h, a, u, p, v], E.protectAttrs = function(t) {
    if (t) {
      t = e.merge(t);
    ...
    addAttr: function(e, t, n) {
      var r = this,
        ...
        s, o;
      t = t || {}, n = p in t ? t[p] : n;
      if (n && !r.attrAdded(e)) i.addAll(e, {
        lazy: t,
        added: !0
      });
      else if (!r.attrAdded(e) || i.get(e, b)) o = c in t, o && (s = t.value, delete t.value), t.added = !0, t.initializing = !0, i.addAll(e, t), o && r.set(e, s), i.remove(e, m);
      return r
    },
    ...
    _isLazyAttr: function(e) {
      return this._state.get(e, y)
    },
    _addLazyAttr: function(e) {
      var t = this._state,
        n = t.get(e, y);
      t.add(e, b, !0), t.remove(e, y), this.addAttr(e, n)
    },
    set: function(e, t, n) {
    ...
    _setAttr: function(t, r, s, o) {
      var u = !0,
        ...
        l = this._stateProxy,
        h, p, d, v, m, g, y;
      return t.indexOf(i) !== -1 && (d = t, v = t.split(i), t = v.shift()), this._isLazyAttr(t) && this._addLazyAttr(t), h = a.getAll(t, !0) || {}, p = !(c in h), l && t in l && !h._bypassProxy && (p = !1), g = h.writeOnce, y = h.initializing, !p && !o && (g && (u = !1), h.readOnly && (u = !1)), !y && !o && g === f && (u = !1), u && (p || (m = this.get(t)), v && (r = n.setValue(e.clone(m), v, r), r === undefined && (u = !1)), u && (s = s || {}, !this._fireAttrChange || y ? this._setAttrVal(t, d, m, r, s) : this._fireAttrChange(t, d, m, r, s))), this
    },
    _getAttr: function(e) {
      var t = this,
        r = e,
        o = t._state,
        u, a, f, l;
      return e.indexOf(i) !== -1 && (u = e.split(i), e = u.shift()), t._tCfgs && t._tCfgs[e] && (l = {}, l[e] = t._tCfgs[e], delete t._tCfgs[e], t._addAttrs(l, t._tVals)), t._isLazyAttr(e) && t._addLazyAttr(e), f = t._getStateVal(e), a = o.get(e, s), a && !a.call && (a = this[a]), f = a ? a.call(t, f, r) : f, f = u ? n.getValue(f, u) : f, f
    },
    _getStateVal: function(e) {
      var t = this._stateProxy;
      return t && e in t && !this._state.get(e, v) ? t[e] : this._state.get(e, c)
    },
    _setStateVal: function(e, t) {
      var n = this._stateProxy;
      n && e in n && !this._state.get(e, v) ? n[e] = t : this._state.add(e, c, t)
    },
    _setAttrVal: function(e, t, n, i, s) {
      var o = this,
        u = !0,
        a = this._state.getAll(e, !0) || {},
        f = a.validator,
        l = a.setter,
        c = a.initializing,
        h = this._getStateVal(e),
        p = t || e,
        d, v;
      return f && (f.call || (f = this[f]), f && (v = f.call(o, i, p, s), !v && c && (i = a.defaultValue, v = !0))), !f || v ? (l && (l.call || (l = this[l]), l && (d = l.call(o, i, p, s), d === w ? c ? i = a.defaultValue : u = !1 : d !== undefined && (i = d))), u && (!t && i === h && !r.isObject(i) ? u = !1 : (g in a || (a.initValue = i), o._setStateVal(e, i)))) : u = !1, u
    },
    ...
    _getAttrs: function(e) {
      ...
      for (i = 0, s = e.length; i < s; i++) {
        r = e[i];
        if (!o || this._getStateVal(r) != this._state.get(r, g)) t[r] = this.get(r)
      }
      return t
    },
    addAttrs: function(e, t, n) {
      var r = this;
      return e && (r._tCfgs = e, r._tVals = r._normAttrVals(t), r._addAttrs(e, r._tVals, n), r._tCfgs = r._tVals = null), r
    },
    _addAttrs: function(e, t, n) {
      var r = this,
        i, s, o;
      for (i in e) e.hasOwnProperty(i) && (s = e[i], s.defaultValue = s.value, o = r._getAttrInitVal(i, s, r._tVals), o !== undefined && (s.value = o), r._tCfgs[i] && delete r._tCfgs[i], r.addAttr(i, s, n))
    },
    _protectAttrs: E.protectAttrs,
    _normAttrVals: function(e) {
      var t = {},
        n = {},
        r, s, o, u;
      if (e) {
        for (u in e) e.hasOwnProperty(u) && (u.indexOf(i) !== -1 ? (r = u.split(i), s = r.shift(), o = n[s] = n[s] || [], o[o.length] = {
          path: r,
          value: e[u]
        }) : t[u] = e[u]);
        return {
    ...
    _getAttrInitVal: function(e, t, r) {
      var i = t.value,
        ...
        o, u = !1,
        a, f, l, c, h, p, d;
      !t.readOnly && r && (a = r.simple, a && a.hasOwnProperty(e) && (i = a[e], u = !0)), s && !u && (s.call || (s = this[s]), s && (o = s.call(this, e), i = o));
      if (!t.readOnly && r) {
        f = r.complex;
        if (f && f.hasOwnProperty(e) && i !== undefined && i !== null) {
          d = f[e];
          for (l = 0, c = d.length; l < c; ++l) h = d[l].path, p = d[l].value, n.setValue(i, h, p)
        }
      }
      return i
    },
...
YUI.add("event-custom-complex", function(e, t) {
  var n, r, i, s = {},
    o = e.CustomEvent.prototype,
    u = e.EventTarget.prototype,
    a = function(e, t) {
      var n;
      for (n in t) r.hasOwnProperty(n) || (e[n] = t[n])
    };
  e.EventFacade = function(e, t) {
    e = e || s, this._event = e, this.details = e.details, this.type = e.type, this._type = e.type, this.target = e.target, this.currentTarget = t, this.relatedTarget = e.relatedTarget
  ...
  }), o.fireComplex = function(t) {
    var n, r, i, s, o, u, a, f, l, c = this,
      h = c.host || c,
      p, d;
    if (c.stack && c.queuable && c.type != c.stack.next.type) return c.stack.queue.push([c, t]), !0;
    n = c.stack || {
      id: c.id,
      next: c,
      silent: c.silent,
      ...
      bubbling: null,
      type: c.type,
      afterQueue: new e.Queue,
      defaultTargetOnly: c.defaultTargetOnly,
      queue: []
    }, f = c.getSubs(), c.stopped = c.type !== n.type ? 0 : n.stopped, c.prevented = c.type !== n.type ? 0 : n.prevented, c.target = c.target || h, c.stoppedFn && (a = new e.EventTarget({
      fireOnce: !0,
      context: h
    }), c.events = a, a.on("stopped", c.stoppedFn)), c.currentTarget = h, c.details = t.slice(), c._facade = null, r = c._getFacade(t), e.Lang.isObject(t[0]) ? t[0] = r : t.unshift(r), f[0] && c._procSubs(f[0], t, r), c.bubbles && h.bubble && !c.stopped && (d = n.bubbling, n.bubbling = c.type, n.type != c.type && (n.stopped = 0, n.prevented = 0), u = h.bubble(c, t, null, n), c.stopped = Math.max(c.stopped, n.stopped), c.prevented = Math.max(c.prevented, n.prevented), n.bubbling = d), c.prevented ? c.preventedFn && c.preventedFn.apply(h, t) : c.defaultFn && (!c.defaultTargetOnly && !n.defaultTargetOnly || h === r.target) && c.defaultFn.apply(h, t), c._broadcast(t);
    if (f[1] && !c.prevented && c.stopped < 2)
      if (n.id === c.id || c.type != h._yuievt.bubbling) {
        c._procSubs(f[1], t, r);
        while (p = n.afterQueue.last()) p()
      } else l = f[1], n.execDefaultCnt && (l = e.merge(l), e.each(l, function(e) {
        e.postponed = !0
    ...
    if (n.id === c.id) {
      s = n.queue;
      while (s.length) i = s.pop(), o = i[0], n.next = o, o.fire.apply(o, i[1]);
      c.stack = null
    }
    return u = !c.stopped, c.type != h._yuievt.bubbling && (n.stopped = 0, n.prevented = 0, c.stopped = 0, c.prevented = 0), c._facade = null, u
  }, o._getFacade = function() {
    var t = this._facade,
      n, r = this.details;
    return t || (t = new e.EventFacade(this, this.currentTarget)), n = r && r[0], e.Lang.isObject(n, !0) && (a(t, n), t.type = n.type || t.type), t.details = this.details, t.target = this.originalTarget || this.target, t.currentTarget = this.currentTarget, t.stopped = 0, t.prevented = 0, this._facade = t, this._facade
  ...
  }, u.addTarget = function(t) {
    this._yuievt.targets[e.stamp(t)] = t, this._yuievt.hasTargets = !0
  }, u.getTargets = function() {
    return e.Object.values(this._yuievt.targets)
  }, u.removeTarget = function(t) {
    delete this._yuievt.targets[e.stamp(t)]
  }, u.bubble = function(e, t, n, r) {
    var i = this._yuievt.targets,
      s = !0,
      o, u = e && e.type,
      a, f, l, c, h = n || e && e.target || this,
      p;
    if (!e || !e.stopped && i)
      for (f in i)
        if (i.hasOwnProperty(f)) {
          o = i[f], a = o.getEvent(u, !0), c = o.getSibling(u, a), c && !a && (a = o.publish(u)), p = o._yuievt.bubbling, o._yuievt.bubbling = u;
          if (!a) o._yuievt.hasTargets && o.bubble(e, t, h, r);
          else {
            a.sibling = c, a.target = h, a.originalTarget = h, a.currentTarget = o, l = a.broadcast, a.broadcast = !1, a.emitFacade = !0, a.stack = r, s = s && a.fire.apply(a, t || e.details || []), a.broadcast = l, a.originalTarget = null;
            if (a.stopped) break
          }
...
YUI.add("attribute-observable", function(e, t) {
  ...
  o._ATTR_CFG = [i], o.prototype = {
    ...
    _fireAttrChange: function(t, n, o, u, a) {
      var f = this,
        l = t + r,
        c = f._state,
        h, p, d;
      c.get(t, s) || (d = {
        queuable: !1,
        defaultTargetOnly: !0,
        defaultFn: f._defAttrChangeFn,
        silent: !0
      }, p = c.get(t, i), p !== undefined && (d.broadcast = p), f.publish(l, d), c.add(t, s, !0)), h = a ? e.merge(a) : f._ATTR_E_FACADE, h.attrName = t, h.subAttrName = n, h.prevVal = o, h.newVal = u, f.fire(l, h)
    },
    _defAttrChangeFn: function(e) {
      this._setAttrVal(e.attrName, e.subAttrName, e.prevVal, e.newVal, e.opts) ? e.newVal = this.get(e.attrName) : e.stopImmediatePropagation()
    }
  }, e.mix(o, n, !1, null, 1), e.AttributeObservable = o, e.AttributeEvents = o
}, "3.9.0", {
...
YUI.add("base-core", function(e, t) {
  ...
  v._ATTR_CFG = p._ATTR_CFG.concat("cloneDefaultValue"), v._NON_ATTRS_CFG = ["plugins"], v.NAME = "baseCore", v.ATTRS = {
    ...
    _filterAttrCfgs: function(e, t) {
      var n = null,
        r, i = e.ATTRS;
      if (i)
        for (r in i) t[r] && (n = n || {}, n[r] = t[r], t[r] = null);
      return n
    },
    ...
    _initHierarchyData: function() {
      var e = this.constructor,
        t, n, r, i, s, o = !e._ATTR_CFG_HASH,
        u, a = this._allowAdHocAttrs ? {} : null,
        f = [],
        l = [];
      t = e;
      while (t) {
        f[f.length] = t, t.ATTRS && (l[l.length] = t.ATTRS);
        if (o) {
          i = t._ATTR_CFG, s = s || {};
          if (i)
            for (n = 0, r = i.length; n < r; n += 1) s[i[n]] = !0
        }
        if (this._allowAdHocAttrs) {
          u = t._NON_ATTRS_CFG;
          if (u)
            for (n = 0, r = u.length; n < r; n++) a[u[n]] = !0
        }
        t = t.superclass ? t.superclass.constructor : null
      }
      o && (e._ATTR_CFG_HASH = s), this._classes = f, this._nonAttrs = a, this._attrs = this._aggregateAttrs(l)
    },
    _attrCfgHash: function() {
      return this.constructor._ATTR_CFG_HASH
    },
    _aggregateAttrs: function(t) {
      var s, o, u, h, p, v, m, g = this._attrCfgHash(),
        y, b = {};
      if (t)
        for (v = t.length - 1; v >= 0; --v) {
          o = t[v];
          for (s in o) o.hasOwnProperty(s) && (u = d({}, o[s], g), h = u.value, m = u.cloneDefaultValue, h && (m === undefined && (f === h.constructor || r.isArray(h)) || m === l || m === !0 ? u.value = e.clone(h) : m === c && (u.value = e.merge(h))), p = null, s.indexOf(i) !== -1 && (p = s.split(i), s = p.shift()), y = b[s], p && y && y.value ? n.setValue(y.value, p, h) : p || (y ? (y.valueFn && a in u && (y.valueFn = null), d(y, u, g)) : b[s] = u))
        }
      return b
    },
    _initHierarchy: function(e) {
      var t = this._lazyAddAttrs,
        n, r, i, s, o, a, f, l = this._getClasses(),
        c = this._getAttrCfgs(),
        h = l.length - 1;
      for (i = h; i >= 0; i--) {
        n = l[i], r = n.prototype, f = n._yuibuild && n._yuibuild.exts;
        if (f)
          for (s = 0, o = f.length; s < o; s++) f[s].apply(this, arguments);
        this.addAttrs(this._filterAttrCfgs(n, c), e, t), this._allowAdHocAttrs && i === h && this.addAttrs(this._filterAdHocAttrs(c, e), e, t), r.hasOwnProperty(u) && r.initializer.apply(this, arguments);
        if (f)
          for (s = 0; s < o; s++) a = f[s].prototype, a.hasOwnProperty(u) && a.initializer.apply(this, arguments)
      }
    },
...
YUI.add("base-observable", function(e, t) {
  ...
  f._ATTR_CFG = u._ATTR_CFG.concat(), f._NON_ATTRS_CFG = ["on", "after", "bubbleTargets"], f.prototype = {
    ...
    init: function(e) {
      ...
      }), this._preInitEventCfg(e), this.fire(i, {
        cfg: e
      }), this
    },
...
YUI.add("base-base", function(e, t) {
  ...
  var n = e.AttributeCore,
    ...
    i = e.BaseCore,
    s = e.BaseObservable;
  o._ATTR_CFG = i._ATTR_CFG.concat(s._ATTR_CFG), o._NON_ATTRS_CFG = i._NON_ATTRS_CFG.concat(s._NON_ATTRS_CFG), o.NAME = "base", o.ATTRS = n.protectAttrs(i.ATTRS), e.mix(o, i, !1, null, 1), e.mix(o, r, !1, null, 1), e.mix(o, s, !0, null, 1), o.prototype.constructor = o, e.Base = o
}, "3.9.0", {
...
YUI.add("base-build", function(e, t) {
  ...
  function l(e, t, n) {
    n._ATTR_CFG && (f.apply(null, arguments), t._ATTR_CFG_HASH = null)
  }
  ...
  function c(t, n, r) {
    ...
    if (r.ATTRS) {
      i = r.ATTRS, s = n.ATTRS;
      for (o in i) i.hasOwnProperty(o) && (s[o] = s[o] || {}, e.mix(s[o], i[o], !0))
    }
  }
  var n = e.BaseCore,
    r = e.Base,
  ...
  r._build = function(t, n, i, u, a, f) {
    ...
    return u && e.mix(c.prototype, u, !0), a && (e.mix(c, l._clean(a, h), !0), p(c, a, h)), c.prototype.hasImpl = l._impl, d && (c.NAME = t, c.prototype.constructor = c), c
  }, a = r._build, e.mix(a, {
  ...
  e.Router = e.extend(f, e.Base, {
    ...
    _dispatch: function(t, n, r) {
      ...
      return s._dispatching = s._dispatched = !0, !u || !u.length ? (s._dispatching = !1, s) : (l = s._getRequest(t, n, r), c = s._getResponse(l), l.next = function(n) {
        var r, h;
        if (n) n === "route" ? (a = [], l.next()) : e.error(n);
        else if (r = a.shift()) typeof r == "string" && (r = s[r]), l.pendingCallbacks = a.length, r.call(s, l, c, l.next);
        else if (h = u.shift()) a = h.callbacks.concat(), f = i.map(h.regex.exec(t) || [], o), f.length === h.keys.length + 1 ? l.params = i.hash(h.keys, f.slice(1)) : l.params = f.concat(), l.pendingRoutes = u.length, l.next()
    ...
    _save: function(t, r) {
      ...
      if (this._html5) this._history[r ? "replace" : "add"](null, {
        ...
        s = e.getLocation().pathname, o = this.get("root");
        if (o === s || o === this._getPathRoot()) t = this.removeRoot(t);
        t === n.getHash() ? e.Router.dispatch() : n[r ? "replaceHash" : "setHash"](t)
      }
      return this
    },
...
YUI.add("pjax-base", function(e, t) {
  function s() {}
  var n = e.config.win,
    r = e.ClassNameManager.getClassName("pjax"),
    i = "navigate";
  s.prototype = {
    _regexURL: /^((?:[^\/#?:]+:\/\/|\/\/)[^\/]*)?([^?#]*)(\?[^#]*)?(#.*)?$/,
...
YUI.add("pjax-content", function(e, t) {
  ...
  n.prototype = {
    getContent: function(t) {
      var n = {},
        r = this.get("contentSelector"),
        i = e.Node.create(t || ""),
        s = this.get("titleSelector"),
        o;
    ...
    _onPjaxIOComplete: function(e, t, n) {
      var r = this.getContent(t.responseText),
        i = n.route,
        s = i.req,
        o = i.res;
...
/* YUI 3.9.0 (build 5827) Copyright 2013 Yahoo! Inc. http://yuilibrary.com/license/ */
YUI.add("pjax", function(e, t) {
  var n = ["loadContent", "_defaultRoute"],
    r = "error",
    i = "load";
  e.Pjax = e.Base.create("pjax", e.Router, [e.PjaxBase, e.PjaxContent], {
    initializer: function() {
      this.publish(r, {
        defaultFn: this._defCompleteFn
      }), this.publish(i, {
        defaultFn: this._defCompleteFn
      })
    },
    _defaultRoute: function(e, t, n) {
      var s = t.ioResponse,
        o = s.status,
        u = o >= 200 && o < 300 ? i : r;
      this.fire(u, {
    ...
    _defCompleteFn: function(t) {
      var n = this.get("container"),
        r = t.content;
      n && r.node && n.setHTML(r.node), r.title && e.config.doc && (e.config.doc.title = r.title)
    }
  }, {
    ATTRS: {
      container: {
